...
public class Burger {
	...
	public BurgerCategory getCategory() {
		return category;
	}

	public void setCategory(BurgerCategory category) {
		this.category = category;
	}

	@Override
	public String toString() {
		return "Burger [id=" + id + ", sku=" + sku + ", name=" + name + ", description=" + description + ", unitPrice="
